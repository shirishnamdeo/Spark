...
[Bugs]
ERROR: org.apache.spark.SparkException: Values to assemble cannot be null.
Reason: 
	This error is thrown by VectorAssembler when any of the features are null. 
	Please verify that you rows doesn't contain null values. If there are null values you must convert it into a default numeric feature before 
	VectorAssembling.
...
// SparkML Doc: Automatically identify categorical features, and index them.
